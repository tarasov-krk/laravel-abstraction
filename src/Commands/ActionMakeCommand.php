...
class ActionMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new action for the specified module.';
    ...
    {
        $pieces = preg_split('/(?=[A-Z])/', $this->argument('action'), -1, PREG_SPLIT_NO_EMPTY);
    ...
    {
        return [
            ['action', InputArgument::REQUIRED, 'The name of action will be created.'],
    ...
    protected function getDestinationFilePath()
    {
        ...
        $modelPath = GenerateConfigReader::read('action');
    ...
    public function getDefaultNamespace(): string
    {
        ...
        return $module->config('paths.generator.action.namespace') ?: $module->config('paths.generator.action.path',
            'Actions');
    }
}
